...
python client/query_snaptron.py --region "chr2:29446395-30142858" --contains 1 --thresholds "samples_count>=100&annotated=1" | wc -l
python client/query_snaptron.py --region "chr11:82970135-82997450" --contains 1 --thresholds "samples_count>=100&coverage_sum>=1000" --filters "description:cortex" | wc -l
