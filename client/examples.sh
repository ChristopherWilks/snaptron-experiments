#!/bin/bash -x
python query_snaptron.py --query-file ../data/alk_alt_tss.hg19.tsv --datasrc srav1 --function jir | wc -l
...
python query_snaptron.py --query-file ../data/small_ssc_test.tsv --function shared --datasrc gtex
